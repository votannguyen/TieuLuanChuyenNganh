            ...
            <main>
                <div class="slider-area ">
                    ...
                    <div class="slider-active">
                        <div class="single-slider slider-height data-background-home">
                            <div class="container">
                                    ...
                                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-8">
                                        <div class="hero__caption">
                                            ...
                                            <div class="hero__btn" data-animation="fadeInRight" data-delay="1s">
                                                <a href="industries.html" class="btn btn1 hero-btn">Shop Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-8">
                                        <div class="hero__caption">
                                            ...
                                            <div class="hero__btn" data-animation="fadeInRight" data-delay="1s">
                                                <Link href="industries.html" class="btn btn1 hero-btn">Shop Now</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- Best Product Start --> */}
                <div class="best-product-area lf-padding" >
                    <div class="product-wrapper bg-height" style={{ backgroundimage: "url('assets/img/categori/card.png')" }}>
